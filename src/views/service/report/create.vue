                           ...
                           <table class="table table-striped">
                              <thead>
                                 <tr>
                                    <th>Items</th>
                                    <th>Size</th>
                                    <th class="no-wrap">Texture Type</th>
                                 </tr>
                              </thead>
                              <tbody>
                              <template v-if="location.objects">
                                 <tr v-for="object in location.objects" :key="object.id">
                                    ...
                                    <td class="no-wrap">{{ object.size }}</td>
                                    <td class="no-wrap">{{ object.texture_type }}</td>
                       ...
                       <section class="row">
                           <div class="col-sm-6 col-xs-12">
                              <div class="form-group form-group-xs">
                                 ...
                                 <select  required  v-model="form.payment_status" class="form-control custom-select">
                                    <option :value="null" disabled selected >Select payment type</option>
                                    <template v-if="payment_status">
                                       <option v-for="(status, index) in payment_status" :value="status.value" :key="index">{{ status.value }}</option>
                                    </template>
                                 </select>
                              </div>
                           </div>
                           <div class="col-sm-6 col-xs-12">
                              <div class="form-group form-group-xs">
                                 ...
                                 <select  required  v-model="form.payment_method" class="form-control custom-select">
                                    <option :value="null" disabled selected >Select payment type</option>
                                    <template v-if="payment_types">
                                       <option v-for="(type, index) in payment_types" :value="type.value" :key="index">{{ type.value }}</option>
                                    </template>seriv
                                 </select>
                              </div>
                           </div>
                        ...
                        <section class="row">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                 ...
                                 <input step="0.01" required type="number" autocomplete="off" class="form-control form-control-lg" v-model="form.amount_received">
                              </div>
                           </div>
                              ...
                              <div class="form-group form-group-xs">
                                 ...
                                 <input type="text"  class="form-control form-control-lg" autocomplete="off" readonly v-model="form.net_amount">
                              </div>
                           </div>
